				...
				<div class="box-body">
					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<textarea name="keterangan" class="input-control" placeholder="Ketarangan"></textarea>
					...
					<?php
						...
						if(isset($_POST['submit'])) {
							...
							if(!in_array($formatfile, $allowedtype)){
								...
								echo '<div class="alert alert-error">Ukuran file tidak boleh melebihi 10MB</div>';
