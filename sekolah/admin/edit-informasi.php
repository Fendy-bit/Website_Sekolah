				...
				<div class="box-body">
					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<textarea name="keterangan" class="input-control" placeholder="Ketarangan" id="keterangan"><?= $p->keterangan ?></textarea> 
						</div>
						...
						if(isset($_POST['submit'])) {
							...
							$judul	= addslashes(ucwords($_POST['judul'])) ;
						 	...
						 	if ($_FILES['gambar'] ['name'] != '') {
								...
								$allowedtype= array('png','jpg','jpeg', 'gif', 'heic' );
									...
									if(!in_array($formatfile, $allowedtype)){
										...
										echo '<div class="alert alert-error">Ukuran file tidak boleh melebihi 1MB</div>';
